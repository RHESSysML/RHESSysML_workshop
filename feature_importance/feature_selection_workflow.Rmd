...
We can also look at the key study area characteristics. In this study, there are six landscape positions where RHESSys was run.
...
```{r imp_summary_plot_0}
plot_removed_imp(clim = 0)
```

#### VIF Summary Plot

```{r vif_summary_plot_0}
...
```{r imp_summary_plot_2}
plot_removed_imp(clim = 2)
```

#### VIF Summary Plot

```{r vif_summary_plot_2}
